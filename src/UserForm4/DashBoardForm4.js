...
const DashBoardForm4 = ({ formData, handleChange, nextStage, prevStage }) => {

    const serviceDescription =
        servicesData[0].services.find((service) => service.id === 4)
            ?.description || "";
