...
const DashBoardForm6 = ({ formData, handleChange, nextStage, prevStage }) => {
    
    const serviceDescription =
        servicesData[0].services.find((service) => service.id === 6)
            ?.description || "";
