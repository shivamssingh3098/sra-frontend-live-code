            ...
            <div className="w-full max-w-4xl bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="text-center mb-6">
                    <div className="flex justify-between items-start mb-4">
                        <div className="text-left">सेवा क्र.१३</div>
                ...
                <div className="space-y-6 text-sm">
                    ...
                    <div className="mt-8">
                        <p className="font-medium text-wrap d-flex" style={{ marginLeft: '40px' }}>
                            <b>विषय :- PAP सदनिका वाटपाबाबत आदेशाची प्रमाणित प्रत उपलब्ध करून देणेबाबत. </b>
                        </p>
                        ...
                        <div className="space-y-4">
                            <p>
                                श्री, {formData.name || "_______"} {" "}
                                यांना {formData.sahakari || "_______"} {" "}
                                सहकारी गृहनिर्माण संस्थेच्या इमारतीमध्ये सदनिका क्र. {formData.sadnika || "_______"} {" "}
                                वाटप करण्यात आली आहे. तरी सदर सदनिका वाटप पत्राच्या आदेशाची प्रमाणित प्रत उपलब्ध करून देण्यात यावी.    
                            </p>
                        </div>
                    </div>
