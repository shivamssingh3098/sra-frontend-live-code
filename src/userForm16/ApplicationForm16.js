...
import DashBoardForm16 from "./DashBoardForm16";
  ...
  return (
    <div className="min-h-screen p-4 bg-gray-100 flex justify-center">
      <div className="w-full max-w-4xl bg-white p-6 rounded shadow-md">
        ...
        {currentStage === 1 && <UploadForm16 />}
        {currentStage === 2 && <Form16 formData={formData} />}
...
export default ApplicationForm16;
