...
import DashBoardForm14 from "./DashBoardForm14";
import Form14 from "./Form14";
import UploadForm14 from "./UploadForm14";
...
const CertificateStage = ({ formData }) => (
  <div className="min-h-screen bg-gray-50 p-4 flex justify-center">
    <div className="w-full max-w-4xl bg-white rounded-lg shadow-lg p-14">
      {/* Certificate Header */}
      <div className="text-center mb-6">
        <div className="flex justify-between items-start mb-4">
          <div className="text-left">सेवा क्र.७</div>
...
const ApplicationForm14 = ({ formData: initialFormData }) => {
  ...
  return (
    <div className="min-h-screen p-4 bg-gray-100 flex justify-center">
      <div className="w-full max-w-4xl bg-white p-6 rounded shadow-md">
        ...
        {currentStage === 1 && <UploadForm14 />}
        {currentStage === 2 && <Form14 formData={formData} />}

        {/* Buttons */}
        <div className="flex flex-wrap justify-between mt-14 gap-4">
...
export default ApplicationForm14;
