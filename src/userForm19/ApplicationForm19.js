...
import DashBoardForm19 from "./DashBoardForm19";
import UploadForm19 from "./UploadForm19";
  ...
  return (
    <div className="min-h-screen p-4 bg-gray-100 flex justify-center">
      <div className="w-full max-w-4xl bg-white p-6 rounded shadow-md">
        ...
        {currentStage === 1 && <UploadForm19 />}
        {currentStage === 2 && <Form19 formData={formData} />}
...
export default ApplicationForm19;
