...
import DhukanForm from "./DhukanForm";
import WordForm from "./WordForm";

const DashboardForm19 = ({ nextStage, prevStage }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.name || !formData.date || !formData.mobile || !formData.address) {
  ...
  const serviceDescription =
    servicesData[0].services.find((service) => service.id === 19)?.description || "";
      ...
      <div className="min-h-screen bg-gray-50 p-4 flex justify-center">
        <div className="w-full max-w-6xl bg-white rounded-lg shadow p-6">
          ...
          <div className="bg-blue-900 text-white text-center p-2 rounded text-sm md:text-base font-semibold">
            सेवा क्र.१९ {serviceDescription}
          </div>
          ...
          >
            ...
            {/* Bhukhand */}
            <DhukanForm formData={formData} setFormData={setFormData} />
            ...
            {/* Nagarpalika */}
            <MuncipalCooperation formData={formData} setFormData={setFormData} />
          ...
          {errorMessage && (
            <p className="text-red-600 font-semibold text-sm text-center mt-4">
              {errorMessage}
            </p>
          )}
          {successMessage && (
            <p className="text-green-600 font-semibold text-sm text-center mt-4">
              {successMessage}
            </p>
          )}
...
export default DashboardForm19;
