...
const DashboardForm15 = ({ formData, handleChange, nextStage, prevStage }) => {

    const serviceDescription =
        servicesData[0].services.find((service) => service.id === 15)
            ?.description || "";
    return (
        <div>
            <div className="min-h-screen bg-gray-50 p-4 flex justify-center">
                <div className="w-full max-w-6xl bg-white rounded-lg shadow p-6">
                    ...
                    <div className="bg-blue-900 text-white text-center p-2 rounded text-sm md:text-base font-semibold">
                        सेवा क्र.१५ {serviceDescription}
                    </div>
                    ...
                    <form className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 text-sm">
                        ...
                        {/* District */}
                        <div>
                            <label className="font-medium block mb-1"> जिल्हा <span className="text-red-500">*</span>
                            </label>
                            <select
                                name="जिल्हा"
...
export default DashboardForm15;
