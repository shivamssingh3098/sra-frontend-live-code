...
import DashBoardForm21 from "./DashBoardForm21";
import UploadForm21 from "./UploadForm21";
  ...
  return (
    <div className="min-h-screen p-4 bg-gray-100 flex justify-center">
      <div className="w-full max-w-4xl bg-white p-6 rounded shadow-md">
        ...
        {currentStage === 1 && <UploadForm21 />}
        {currentStage === 2 && <Form21 formData={formData} />}
