...
import DashBoardForm18 from "./DashBoardForm18";
import UploadForm18 from "./UploadForm18";
      ...
      >
        ...
        <div
          className={`ml-2 text-sm ${
            index <= currentStage ? "text-blue-600" : "text-gray-600"
          }`}
        >
          {stage}
        </div>
  ...
  return (
    <div className="min-h-screen p-4 bg-gray-100 flex justify-center">
      <div className="w-full max-w-4xl bg-white p-6 rounded shadow-md">
        ...
        {currentStage === 1 && <UploadForm18 />}
        {currentStage === 2 && <Form18 formData={formData} />}
...
export default ApplicationForm18;
