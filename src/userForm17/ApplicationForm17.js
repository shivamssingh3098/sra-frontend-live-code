...
import DashBoardForm17 from "./DashBoardForm17";
import UploadForm17 from "./UploadForm17";
  ...
  return (
    <div className="min-h-screen p-4 bg-gray-100 flex justify-center">
      <div className="w-full max-w-4xl bg-white p-6 rounded shadow-md">
        ...
        {currentStage === 1 && <UploadForm17 />}
        {currentStage === 2 && <Form17 formData={formData} />}
...
export default ApplicationForm17;
