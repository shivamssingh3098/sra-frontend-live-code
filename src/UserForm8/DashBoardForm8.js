...
const DashBoardForm8 = ({ formData, handleChange, nextStage, prevStage }) => {

    const serviceDescription =
        servicesData[0].services.find((service) => service.id === 7)
            ?.description || "";
    return (
        <div>
