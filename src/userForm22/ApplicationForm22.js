...
import DashBoardForm22 from "./DashBoardForm22";
import UploadForm22 from "./UploadForm22";
  ...
  return (
    <div className="min-h-screen p-4 bg-gray-100 flex justify-center">
      <div className="w-full max-w-4xl bg-white p-6 rounded shadow-md">
        ...
        {currentStage === 1 && <UploadForm22 />}
        {currentStage === 2 && <Form22 formData={formData} />}
